...
(function() {
  ...
  grammar = {
    ...
    Declaration: [
      o('CONST DeclaratorWithInitializer',
      function() {
    ...
    Declarator: [
      ...
      o('IdentifierWithOptionalTypeAnnotation',
      function() {
    ...
    DeclaratorWithInitializer: [
      o('IdentifierWithOptionalTypeAnnotation = Expression',
      function() {
        return new VariableDeclarator({
          id: $1,
          init: $3
    ...
    IdentifierWithOptionalTypeAnnotation: [
      o('Identifier'),
      o('Identifier TYPE_ANNOTATION_DELIMITER TypeAnnotation TYPE_ANNOTATION_DELIMITER',
      function() {
        $1.typeAnnotation = $3;
        return $1;
      }),
      o('TYPE_ANNOTATION_DELIMITER TypeAnnotation TYPE_ANNOTATION_DELIMITER Identifier',
      function() {
        $4.typeAnnotation = $2;
        return $4;
      })
    ...
    TypeAnnotation: [
      o('Identifier',
      function() {
        return new TSTypeAnnotation($1);
      })
    ],
    TypeSignature: [
      o('Identifier TYPE_SIGNATURE_:: TypeAnnotation',
      function() {
