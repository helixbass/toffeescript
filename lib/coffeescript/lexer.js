...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    literalToken() {
      var hasFollowingWhitespace, match, message, origin, prev, ref, ref1, ref2, ref3, ref4, ref5, skipToken, tag, token, value;
      if (match = OPERATOR.exec(this.chunk)) {
        [value] = match;
        if (CODE.test(value)) {
          this.tagParameters();
        }
        hasFollowingWhitespace = /^\s+/.test(this.chunk.slice(value.length));
      } else {
        value = this.chunk.charAt(0);
        hasFollowingWhitespace = /^\s+/.test(this.chunk.slice(1));
      }
      tag = value;
      prev = this.prev();
      ...
      if (value === ';') {
        ...
        tag = 'BIN?';
      } else if (value === '|' && (!(prev != null ? prev.spaced : void 0) || !hasFollowingWhitespace)) {
        tag = 'TYPE_ANNOTATION_DELIMITER';
      } else if (value === '::' && ((prev != null ? prev.spaced : void 0) && hasFollowingWhitespace)) {
        tag = 'TYPE_SIGNATURE_::';
      } else if (prev) {
  ...
  JS_KEYWORDS = ['true', 'false', 'null', 'this', 'new', 'delete', 'typeof', 'in', 'instanceof', 'return', 'throw', 'break', 'continue', 'debugger', 'yield', 'await', 'if', 'else', 'switch', 'for', 'while', 'do', 'try', 'catch', 'finally', 'class', 'extends', 'super', 'import', 'export', 'default', 'const', 'let'];
  ...
  RESERVED = ['case', 'function', 'var', 'void', 'with', 'enum', 'native', 'implements', 'interface', 'package', 'private', 'protected', 'public', 'static'];
